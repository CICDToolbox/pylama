<p align="center">
    ...
    <br />
    <a href="https://github.com/CICDToolbox/pylama/actions/workflows/cicd-pipeline-shared.yml">
        <img src="https://img.shields.io/github/workflow/status/CICDToolbox/pylama/CICD%20Pipeline%20(Shared)/master?label=shared%20pipeline&style=for-the-badge" alt="Github Build Status" />
    </a>
    <a href="https://github.com/CICDToolbox/pylama/actions/workflows/cicd-pipeline-custom.yml">
        <img src="https://img.shields.io/github/workflow/status/CICDToolbox/pylama/CICD%20Pipeline%20(Custom)/master?label=custom%20pipeline&style=for-the-badge" alt="Github Build Status" />
    </a>
    <br />
...
A tool to check your Python project documentation for compliance with [pylama](https://pypi.org/project/pylama/).
